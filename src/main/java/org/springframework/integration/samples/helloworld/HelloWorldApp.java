...
/**
 * Demonstrates a basic Message Endpoint that simply prepends a greetingINT_CHANNEL_MESSAGE
...
public class HelloWorldApp {
	...
	public static void main(String[] args) {
		...
		MessageChannel inputChannel = context.getBean("confirmCancelChannel", MessageChannel.class);
		
		Map<String,String> payload=new HashMap<String, String>();
		payload.put("iq_item_id", "65435");
		payload.put("status", "In-Progress");
		payload.put("retry_count", "1");
